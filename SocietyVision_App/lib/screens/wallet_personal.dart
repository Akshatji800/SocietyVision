...
class _HomePageState extends State<HomePage> {
  ...
  Widget _operationsWidget() {
    return Row(
      ...
      children: <Widget>[
        ...
        _icon(Icons.timelapse, "Renewal"),
        _icon(Icons.payment, "Pay Bills"),
        _icon(Icons.qr_code, "Qr Pay"),
      ],
    );
  }
  ...
  Widget _transectionList() {
    return Column(
      children: <Widget>[
        _transection("Maid Salary", "23 May 2021"),
        _transection("Electricity Bill", "25 June 2021"),
        _transection("Gym Bill", "03 May 2021"),
      ],
    );
  }
